...
# constructing indicator variable whether each column of data is also in the var_list
edu_col_idx <- names(data) %in% var_list

#creating a separate dataset to check summary stats related to education
edu_sum <- data[edu_col_idx]
